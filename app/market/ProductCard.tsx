...
type Product = { slug: string; name: string; image: string; price: string };
    ...
    <Link href={`/market/${product.slug}`} style={{ textDecoration: "none", display: "block" }}>
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ fontSize: "15px", fontWeight: "600", letterSpacing: "0.05em", color: "#f2ede8", textAlign: "center", marginBottom: "6px" }}>
            {product.name}
          </div>
